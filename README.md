...
Transito entre o Design (UX/UI), o Desenvolvimento (Frontend & SQL) e a Qualidade (QA). Meu objetivo é um só: criar soluções que sejam bonitas por fora e organizadas por dentro.
